...
vimp.nnoremap('<leader>bb', ':b<Space>')

-- Search

vimp.nnoremap('n', 'nzzzv')
vimp.nnoremap('N', 'Nzzzv')
vimp.nnoremap({'silent'}, '<leader>ff', ':Rgrep<CR>')
...
vimp.nnoremap({'silent'}, '<leader>wv', ':VimwikiIndex<CR>')
-- vim.api.nvim_del_keymap('n', '<leader>wt')
vimp.nnoremap({'silent'}, '<leader>wtl', ':VimwikiToggleListItem<CR>')
